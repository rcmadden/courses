### Exercise Notes:
# I wrote the Pants class by hand
# The comments and checks are from the course
# The SalesPerson Class was generated by ChatGPT
# Only the initial def __init__(self,  or def function_partial_name was provided
...
print('pants.change_price(10)', pants.change_price(10.0))

print('pants.price: ', pants.price)
print('pants.discount(.10): ',pants.discount(.10))
# print('pants.discount: ', pants.discount)
print('pants.price: ', pants.price)
...
def check_results():
    ...
    print('You made it to the end of the Pants check. Nice job!')
...
def check_results():
    ...
    print('Great job, you made it to the end of the Sales Person code checks!')
